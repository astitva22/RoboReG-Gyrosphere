...
body = pb.loadURDF("/home/astitva/Projects/robotics/RoboReG-research-Gyrosphere/kinematicsSim/outershell.urdf",[0,0,2.5])
...
while(True):
    ...
    pb.applyExternalTorque(body,-1,desired_ang_vel,pb.LINK_FRAME)
